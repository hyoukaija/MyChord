 ...
 */
public final class MyChordInAggressiveJoiningMode extends AbstractChord {
	// messages
	private final Message ackFingerTableMessage;

	protected MyChordInAggressiveJoiningMode(RoutingAlgorithmConfiguration config, RoutingService routingSvc)
	...
	public void prepareHandlers() {
		...
		handler = new MessageHandler() {
			public Message process(final Message msg) {
				...
				MyChordInAggressiveJoiningMode.this.touch((IDAddressPair)msg.getSource());	// notify the algorithm
...
//System.out.println("On " + selfIDAddress.getAddress() + ", succ list.add: " + candidateNode);
				...
				// reply an ACK
				return MyChordInAggressiveJoiningMode.this.ackFingerTableMessage;
			}
		};
